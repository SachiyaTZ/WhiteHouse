      ...
      <View style={styles.container}>
        <ScrollView>
          <View style={{alignItems:'center', marginHorizontal:30}}>
            <Image style={styles.productImg} source={{uri:"https://www.whitehouseproductsltd.com/PRODUCT_IMAGES/6CM1011002.jpg"}}/>
            <Text style={styles.name}>Hydraulic Motors</Text>
            <Text style={styles.price}>$ 140.22</Text>
            <Text style={styles.description}>
            A high torque hydraulic orbital motor is a very effective device for converting hydraulic fluids into mechanical motion. It generally uses an internal gear design one gear set inside another-in order to convey fluid through the system. 
            </Text>
          </View>
